        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="mb-4 lg:mb-0">
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/search" className="text-gray-400 hover:text-blue-400 transition-colors">Search PGs</Link></li>
              <li><Link to="/chatbot" className="text-gray-400 hover:text-blue-400 transition-colors">Chat with Bot</Link></li>
            </ul>
          </div>
          ...
          <div className="mb-4 lg:mb-0">
            ...
            <p className="text-gray-400">
              <a href="mailto:support@pgfinder.com" className="hover:text-blue-400 transition-colors">
                support@pgfinder.com
              </a>
            </p>
            <p className="text-gray-400 mt-2">
              <a href="tel:+919972487827" className="hover:text-blue-400 transition-colors">
                +91 99724 87827
              </a>
            </p>
            <p className="text-gray-400 mt-2">Badagumijaru, Karnataka, India</p>
          </div>
